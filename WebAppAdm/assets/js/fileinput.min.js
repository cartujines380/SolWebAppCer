 ...
 */
(function (e) {
    var t = "{preview}\n" + '<div class="input-group {class}">\n' + "   {caption}\n" + '   <div class="input-group-btn" style="align-content:center">' +"    {browse}\n" + "   </div>\n" + "</div>";
    var n = "{preview}\n{browse}\n";
    var r = '<div class="file-preview {class}">\n' + '   <div class="file-preview-status text-center text-success"></div>\n' + '   <div class="close fileinput-remove text-right">&times;</div>\n' + '   <div class="file-preview-thumbnails"></div>\n' + '   <div class="clearfix"></div>' + "</div>";
    var i = '<div class="form-control file-caption {class}" style="align-content:center">\n' + '   <span class="glyphicon glyphicon-file"></span> <span class="file-caption-name"></span>\n' + "</div>";
    ...
    c.prototype = {
        ...
        renderBrowse: function () {
            ...
            return '<div style="align-content:center;background-color:darkred!important;border-color:darkred !important" class="' + t + '"' + n + "> " + e.browseIcon + e.browseLabel + " </div>"
        },
        renderRemove: function () {
            ...
            return '<button type="button" style="background-color:darkred!important;border-color:darkred !important" class="btn btn-sm btn-round ' + t + '"' + n + ">" + e.removeIcon + e.removeLabel + "</button>"
        },
        renderUpload: function () {
            ...
            if (o(e.uploadUrl)) {
                t = '<button type="submit" style="background-color:darkred!important;border-color:darkred !important" class="btn btn-sm btn-round ' + e.uploadClass + '"' + n + ">" + e.uploadIcon + e.uploadLabel + "</button>"
            } else {
