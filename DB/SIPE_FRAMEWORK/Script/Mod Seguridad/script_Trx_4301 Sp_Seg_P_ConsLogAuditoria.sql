...
set @v_param = '<SP nombre="SIPE_PROVEEDOR.Seguridad.Seg_P_ConsLogAuditoria">  <Param  nombre=''@PI_ParamXML'' tipo=''xml'' posicion=''0'' direccion=''input'' longitud=''-1'' /> </SP>'

--
INSERT INTO @TRANS VALUES (@IdOrg, @IdTrx, 'Reporte Auditoria', 'A', NULL,
	@v_param,
	'S', NULL, NULL, 0, 'SIPE_PROVEEDOR','Proveedor.Seg_P_ConsLogAuditoria', @IdSrv,null,null,null,null,null)
