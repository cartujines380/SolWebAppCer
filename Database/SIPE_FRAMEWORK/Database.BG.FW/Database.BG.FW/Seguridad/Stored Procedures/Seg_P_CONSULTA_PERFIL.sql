...
CREATE procedure [Seguridad].[Seg_P_CONSULTA_PERFIL]
...
AS
	...
	--insert into dbo.Prueba(varlor) values (@PV_idUsuario)
	--insert into dbo.Prueba(varlor) values (@PV_Token)
	--insert into dbo.Prueba(varlor) values (@PV_Maquina)
	--insert into dbo.Prueba(varlor) values (@PV_idAplicacion)
	--insert into dbo.Prueba(varlor) values (@PV_idEmpresa)
	--insert into dbo.Prueba(varlor) values (@PV_idSucursal)
	--insert into dbo.Prueba(varlor) values (@PV_idOrganizacion)
	--insert into dbo.Prueba(varlor) values (@PV_Perfil)

	--insert into dbo.Prueba(varlor) values (@PV_ROLAD)
