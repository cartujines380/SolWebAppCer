...
begin
	...
	values(
	@idOrg,@idTran,'Mantenimiento Contactos','A',null,
	'<SP nombre=''SIPE_PROVEEDOR.Proveedor.Pro_P_Reg_ContactoProveedor''>  
	<Param nombre=''@PI_ParamXML'' tipo=''xml'' longitud=''-1'' posicion=''0'' direccion=''input'' />  
	<Param nombre=''@PI_ParamAlm'' tipo=''xml'' longitud=''-1'' posicion=''1'' direccion=''input'' />  
	<Param nombre=''@PI_Tipo'' tipo=''varchar'' longitud=''5'' posicion=''2'' direccion=''input'' />  
	<Param nombre=''@PI_CodProveedor'' tipo=''varchar'' longitud=''10'' posicion=''3'' direccion=''input'' />  </SP>',
	'S',null,null,27,'SIPE_PROVEEDOR','Proveedor.Pro_P_Reg_ContactoProveedor',27,
	0,0,'','',''
	)
end
