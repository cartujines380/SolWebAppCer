app.controller('IndicadoresController', ['$scope', 'ngAuthSettings', 'IndicadoresService', 'FileUploader', '$sce', 'authService', '$http', '$filter', function ($scope, ngAuthSettings, IndicadoresService, FileUploader, $sce, authService, $http, $filter) {
    ...
    GraficoCobertura(0);
    var d = new Date(2021, 09, 30);//desarrollo p<ra pruebas en produccion quitarlo
    ...
    $scope.Consultar = function () {
        ...
        $scope.cbProveedorUsr = authService.authentication.Usuario;
        console.log($scope.cbProveedorUsr);
        //debugger; 
        var fecha = new Date();
        ...
        var fecha_test = new Date(2021, 09, 30);//solo para probar
