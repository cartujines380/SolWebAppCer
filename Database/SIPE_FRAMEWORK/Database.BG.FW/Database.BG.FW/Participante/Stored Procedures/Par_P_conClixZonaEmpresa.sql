...
CREATE  PROCEDURE [Participante].[Par_P_conClixZonaEmpresa]
	@PI_IdEmpresa int,
	@PI_IdEmpleado int,
	@PI_IdZona int
AS
...
SELECT  cli.IdParticipante IdCliente,Participante.Par_F_getNombreParticipante(cli.IdParticipante) NomCliente,	
			cli.IdVendedor IdEmpleado, Participante.Par_F_getNombreParticipante(cli.IdVendedor) NomEmpleado,
	...
	FROM	Participante.Par_Cliente cli	left outer join Participante.Par_Direccion d 
			on cli.IdParticipante = d.IdParticipante and d.IdTipoDireccion = 4,
