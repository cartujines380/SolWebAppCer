...
app.factory('GeneraContratoService', ['$http', 'ngAuthSettings', function ($http, ngAuthSettings) {
    ...
    var _generarVistaPreviaContrato = function (objPlantilla) {
        Ruta = serviceBase + "api/GeneraContrato/GenerarVistaPreviaContrato/";
        return $http.post(Ruta, objPlantilla).then(function (results) {
            return results;
        });
    };
    ...
    var _getDescargarArchivos = function (listaArchivos) {
        _LeePDFContratos(listaArchivos);
    ...
    GeneraContratoServiceFactory.generarVistaPreviaContrato = _generarVistaPreviaContrato;
