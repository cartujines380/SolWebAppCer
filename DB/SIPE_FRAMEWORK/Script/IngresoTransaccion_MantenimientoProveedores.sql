...
begin
	...
	values(
	@idOrg,@idTran,'Mantenimineto de proveedores','A',null,
	'<SP nombre=''SIPE_PROVEEDOR.Proveedor.Pro_P_MantenimientoProveedor''>  
	<Param nombre=''@PI_ParamXML'' tipo=''xml'' longitud=''-1'' posicion=''0'' direccion=''input'' />  	  
	</SP>',
	'S',null,null,27,'SIPE_PROVEEDOR','Proveedor.Pro_P_MantenimientoProveedor',27,
	0,0,'','',''
	)
end
