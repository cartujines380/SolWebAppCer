...
app.factory('ModificacionProveedor', ['$http', 'ngAuthSettings', function ($http, ngAuthSettings) {
    ...
    return {
        ...
        getGrabaContacto: function (Contactos, codSAPproveedor, identificacion, Zonas, accion) {
        ...
        getPostSolicitudList: function (SolcitudProveedor, SolContacto, SolBanco, SolDireccion, SolDocAdjunto, ViaPago, SolRamo, SolZona, SolProvHistEstado) {
