...
CREATE PROCEDURE [Proveedor].[Pro_P_ConsultaSolProveedorId]
	@PI_ParamXML xml
AS
SET ARITHABORT ON;
BEGIN TRY
	...
	--Declare @ActividadEcoSolicitudProveedor        table ( codigo varchar(25), Detalle varchar(64))
	--Declare @TipoServicioSolicitudProveedor        table ( codigo varchar(25), Detalle varchar(64))
	--Declare @EstadoCivilSolicitudProveedor         table ( codigo varchar(25), Detalle varchar(64))
	--Declare @NacionalidadSolicitudProveedor        table ( codigo varchar(25), Detalle varchar(64))
	--Declare @PaisResidenciaSolicitudProveedor      table ( codigo varchar(25), Detalle varchar(64))
	...
	SELECT a.[IdEmpresa]                 ,a.[IdSolicitud]                ,a.[TipoSolicitud]                   ,h.Detalle DescTipoSolicitud,         a.[TipoProveedor] 
		  ...
		  ,a.ClaseContribuyente          , j.Detalle DescClaseContribuyente , 
		   ...
		   [Proveedor].[Pro_F_SolMedioContacto](a.IdSolicitud ,null,'EMAILSRI')   EMAILSRI,
            ...
            AnioConsti,   LineaNegocio,	l.Detalle DescLineaNegocio,      totalventas,
            princliente,
			PlazoEntrega,
            DespachaProvincia,
	...
	from [Proveedor].[Pro_SolProveedor]        a with(nolock)	     
		 ...
		 left join @ClaseContribuyente        j  on a.ClaseContribuyente  = j.codigo 
...
END TRY
BEGIN CATCH
	exec SP_PROV_Error @sp='[Pro_P_ConsultaSolProveedorId]'
END CATCH
