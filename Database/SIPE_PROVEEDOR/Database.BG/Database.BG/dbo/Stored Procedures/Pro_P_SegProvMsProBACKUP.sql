create procedure [dbo].[Pro_P_SegProvMsProBACKUP]
...
if  (@tipo = 'F')
	...
	begin
		...
		select  @archivo    =  @ruta + 'SegProvMsPro_backup_' + @dia + '.bak'

		select  @archivoPuro = @ruta + 'SegProvMsPro_backup_' + @dia

		BACKUP DATABASE [SegProvMsPro] TO  DISK = @archivo
