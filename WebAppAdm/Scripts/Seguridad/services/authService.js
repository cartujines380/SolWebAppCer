...
app.factory('authService', ['$http', '$q', 'localStorageService', 'ngAuthSettings', function ($http, $q, localStorageService, ngAuthSettings) {
    ...
    var _login = function (loginData) {
        ...
        var data = "grant_type=password&ruc=" + loginData.ruc + "&userName=" + loginData.usernamefrm + "&password=" + loginData.password + "&tokenUser=" + loginData.tokenUser + "&sl=" + loginData.sl + "&sociedad=" + loginData.Sociedad;
        ...
        $http.post(serviceBase + 'token', data, { headers: { 'Content-Type': 'application/x-www-form-urlencoded' } }).success(function (response) {
            ...
            _authentication.RolesAdAplicacion = loginData.Sociedad;
    ...
    var _fillAuthData = function () {
        ...
        if (authData) {
            ...
            _authentication.CargoEmpleado = authData.CargoEmpleado;
            ...
            _authentication.RolesAdAplicacion = authData.RolesAdAplicacion;
        }
    ...
    var _refreshToken = function () {
        ...
        if (authData) {
            ...
            if (authData.useRefreshTokens) {
                ...
                let rolesAdAplicacion = authData.RolesAdAplicacion;
                ...
                $http.post(serviceBase + 'token', data, { headers: { 'Content-Type': 'application/x-www-form-urlencoded' } }).success(function (response) {
                    ...
                    localStorageService.set('authorizationData', { token: response.access_token, UserName: response.username, refreshToken: response.refresh_token, useRefreshTokens: true, tokenUser: response.tokenUser, RolesAdAplicacion: rolesAdAplicacion });
