...
app.factory('SolicitudCitaService', ['$http', 'ngAuthSettings', function ($http, ngAuthSettings) {
    ...
    var _getConsulaGrid = function (tipo, fechadesde, fechahasta, numero, CodSap) {

        Ruta = serviceBase + "Api/SolicitudCita/conBuscarSolicitud/?tipo=" + tipo + '&fechadesde=' + fechadesde + '&fechahasta=' + fechahasta + '&numero=' + numero + '&codProveedor=' + CodSap;
        return $http.get(Ruta).then(function (results) {
            return results;
        });
    };
    ...
    var _getExportarDataCita = function (Tablacabecera, Tabladetalle) {
        ...
        //return $http.get(Ruta, { params: { Tabla: Chofer }, responseType: 'arraybuffer' }).then(function (results) {
        //    return results;
        //});
...
app.factory('ReporteTabularCitasService', ['$http', 'ngAuthSettings', function ($http, ngAuthSettings) {
    ...
    var _getConsulaGrid = function (tipo, fechadesde, fechahasta, numcita) {

        Ruta = serviceBase + "Api/ReportesTransporte/getTabularCitas/?tipo=" + tipo + '&fechadesdeRPT=' + fechadesde + '&fechahastaRPT=' + fechahasta + '&numcita=' + numcita;
        return $http.get(Ruta).then(function (results) {
            return results;
        });
    };

    var _getExportarData = function (tiporeporte, usuarioCreacion, tipo, fechadesde, fechahasta, numcita) {
        ...
        return $http.get(Ruta, { params: { tiporeporte: tiporeporte,usuarioCreacion:usuarioCreacion,tipo: tipo,fechadesdeRPT:fechadesde,fechahastaRPT:fechahasta,numcita:numcita}, responseType: 'arraybuffer' }).then(function (results) {
            return results;
        });
