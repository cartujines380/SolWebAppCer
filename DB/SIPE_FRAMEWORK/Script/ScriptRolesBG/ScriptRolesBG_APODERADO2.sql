...
if exists(
	...
	where IdRol = 39 and CodAD = 'APODERADO2' and Estado = 'A'
)
begin
...
delete from [Seguridad].[Seg_OpcionTransRol] where IdRol = 39 and IdOrganizacion = 39
...
delete from [Seguridad].[Seg_OpcionTransRol] where IdRol = 39 and IdOrganizacion = 1
and IdTransaccion in (78,147,300,301,902)

delete from [Seguridad].[Seg_OpcionTransRol] where IdRol = 39 and IdOrganizacion = 2
...
values(39,2,0,'Rol Apoderado 2','ACTIVE','Rol Apoderado 2')
go

--CONTRATOS
INSERT [Seguridad].[Seg_OpcionTransRol] ([IdRol], [IdOrganizacion], [IdTransaccion], [IdOpcion]) VALUES (39,39,1104,1)
INSERT [Seguridad].[Seg_OpcionTransRol] ([IdRol], [IdOrganizacion], [IdTransaccion], [IdOpcion]) VALUES (39,39,3200,1)
INSERT [Seguridad].[Seg_OpcionTransRol] ([IdRol], [IdOrganizacion], [IdTransaccion], [IdOpcion]) VALUES (39,39,3201,1)
INSERT [Seguridad].[Seg_OpcionTransRol] ([IdRol], [IdOrganizacion], [IdTransaccion], [IdOpcion]) VALUES (39,39,3202,1)
go

insert into Seguridad.Seg_HomologacionRoles(IdRol,CodAD,FechaCreacion,UsuarioCreacion,Estado)
values (39,'APODERADO2',getdate(),'USCRIPT','A')
go
