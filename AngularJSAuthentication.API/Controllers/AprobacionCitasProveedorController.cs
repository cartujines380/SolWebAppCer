...
{
    [RoutePrefix("api/AprobacionCitasProveedor")]
    public class AprobacionCitasProveedorController : ApiController
    {
        [ActionName("conBuscarAprobacionCitasProveedor")]
        [HttpGet]
        ...
        [ActionName("conBuscarDetalleGridProveedor")]
        [HttpGet]
            ...
            try
            {
                ...
                if (ds.Tables["TblEstado"].Rows[0]["CodError"].ToString().Equals("0"))
                {
                    ...
                    foreach (DataRow item in ds.Tables[1].Rows)
                    {
                        ...
                        mod_ChoferVehiculo.imagenurlvehiculo = bajararchivoVehiculo(Convert.ToString(item["idvehiculo"]), Convert.ToString(item["imagenurlvehiculo"]));
        ...
        [ActionName("getGrabarCancelarProveedor")]
        [HttpGet]
                    ...
                    if (FormResponse.success)
                    {
                        try
                        {
                            foreach (DataRow item in ds.Tables[0].Rows)
                            {
                                ...
                                //  WCFEnvioCorreo.CompositeType objResp;
                                //  retorno = objEnvMail.EnviarCorreo("", Convert.ToString(item["Correo"]), "", "", asuntoEmail, mensajeEmail, true, true, false,null);
