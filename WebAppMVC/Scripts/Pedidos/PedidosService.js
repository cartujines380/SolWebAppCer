...
app.factory('PedidosService', ['$http', 'ngAuthSettings', function ($http, ngAuthSettings) {
    ...
    var _getConsPedidosCrossFiltro = function (CodSap, Ruc, Usuario, Opc1, Opc2, Fecha1, Fecha2, Ciudad, NumOrden, SiGrd, SiTxt, SiXml, SiHtml, SiPdf, Almacen, isCross, tipoPedido) {
        if (Almacen == undefined)
            Almacen = "";
        ...
        Ruta = serviceBase + "Api/PedPedidosCross/ConsPedidosCrossFiltro/?CodSap=" + CodSap + '&Ruc=' + Ruc + '&Usuario=' + Usuario
                    ...
                    + '&SiPdf=' + SiPdf + '&Almacen=' + Almacen + '&isCross=' + isCross + '&tipoPedido=' + tipoPedido;
        return $http.get(Ruta).then(function (results) {
            return results;
        });
    };

    var _getExportarCrossConsolidado = function (tipo, codsapex, nomproveedorex, usuariologon, idpedido,
         Ruc, Opc1, Opc2, Fecha1, Fecha2, Ciudad, NumOrden, SiGrd, SiTxt, SiXml, SiHtml, SiPdf, Almacen, isCross, tipoPedido) {
        if (Almacen == undefined)
            Almacen = "";
        if (isCross == undefined) isCross = false;
        Ruta = serviceBase + 'Api/PedPedidosCross/ConsPedidosCrossConsolidadoExportar/?tiposo=' + tipo +
            '&codsapex=' + codsapex + '&nomproveedorex=' + nomproveedorex + '&usuariologonso=' + usuariologon + '&idpedido=' + idpedido
            + '&Ruc=' + Ruc
            + '&Opc1=' + Opc1 + '&Opc2=' + Opc2 + '&Fecha1=' + Fecha1 + '&Fecha2=' + Fecha2 + '&Ciudad=' + Ciudad
            + '&NumOrden=' + NumOrden + '&SiGrd=' + SiGrd + '&SiTxt=' + SiTxt + '&SiXml=' + SiXml + '&SiHtml=' + SiHtml
            + '&SiPdf=' + SiPdf + '&Almacen=' + Almacen + '&isCross=' + isCross + '&tipoPedido=' + tipoPedido;
    ...
    var _getBuscarDetPedidosCrossHis = function (numPedido, codProveedor, idPedido, Ruc, Usuario, Opc1, Opc2, Fecha1, Fecha2, Ciudad, SiGrd, SiTxt, SiXml, SiHtml, SiPdf, Almacen, isCross, tipoPedido) {
        if (Almacen == undefined)
            Almacen = "";
        if (isCross == undefined) isCross = false;
        Ruta = serviceBase + "Api/PedPedidosCross/ConsPedidosCrossDetalleHis/?NumOrden=" + numPedido + '&CodProveedor=' + codProveedor + '&idPedido=' + idPedido+
            '&Ruc=' + Ruc + '&Usuario=' + Usuario + '&Opc1=' + Opc1 + '&Opc2=' + Opc2 + '&Fecha1=' + Fecha1 + '&Fecha2=' + Fecha2 + '&Ciudad=' + Ciudad+
            '&SiGrd=' + SiGrd + '&SiTxt=' + SiTxt + '&SiXml=' + SiXml + '&SiHtml=' + SiHtml + '&SiPdf=' + SiPdf + '&Almacen=' + Almacen + '&isCross=' + isCross + '&tipoPedido=' + tipoPedido;
        return $http.get(Ruta).then(function (results) {
            return results;
        });
    };

    var _getReportePackingList = function (numPedido, codProveedor, nomProveedor, fechaPedido, tipoReporte, usuario,
             Ruc, Opc1, Opc2, Fecha1, Fecha2, Ciudad, SiGrd, SiTxt, SiXml, SiHtml, SiPdf, Almacen, isCross, tipoPedido) {
        if (Almacen == undefined)
            Almacen = "";
        if (isCross == undefined) isCross = false;
        Ruta = serviceBase + "Api/PedPedidosCross/GeneraReportePackingList/?NumOrden=" + numPedido
                                                                        ...
                                                                        + '&Ruc=' + Ruc 
                    + '&Opc1=' + Opc1 + '&Opc2=' + Opc2 + '&Fecha1=' + Fecha1 + '&Fecha2=' + Fecha2 + '&Ciudad=' + Ciudad
                    + '&SiGrd=' + SiGrd + '&SiTxt=' + SiTxt + '&SiXml=' + SiXml + '&SiHtml=' + SiHtml
                    + '&SiPdf=' + SiPdf + '&Almacen=' + Almacen + '&isCross=' + isCross + '&tipoPedido=' + tipoPedido;
        return $http.get(Ruta, { responseType: 'arraybuffer' }).then(function (results) {
            return results;
        });
    ...
    PedidosServiceFactory.getBuscarDetPedidosCrossHis = _getBuscarDetPedidosCrossHis;
    PedidosServiceFactory.getReportePackingList = _getReportePackingList;
    PedidosServiceFactory.getExportarCrossConsolidado = _getExportarCrossConsolidado;
